...
-- buffers
-- no need since I use CTRL-o and CTRL-i
...
-- TODO: consider adding toggle inlay hint back
...
map("n", "<leader>gg", function() terminal.open({ "lazygit" }, {esc_esc = false, ctrl_hjkl = false}) end, { desc = "Lazygit" })
-- personal keybinds
--
